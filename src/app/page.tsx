...
import { projects, strategyItems } from "@/data/site-content";
import { ScrollReveal } from "@/components/ui/scroll-reveal";
import { Marquee } from "@/components/ui/marquee";

const allSkills = [
  "React", "Next.js", "TypeScript", "Python", "FastAPI", "PostgreSQL",
  "Supabase", "Docker", "Tailwind CSS", "Figma", "PowerBI", "Flask",
];
        ...
        <div className="container-shell">
          ...
          <div className="grid gap-5 md:grid-cols-2">
            ...
            <ScrollReveal delay={0.1}>
              ...
              >
                <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-accent/[0.06] border border-accent/[0.08]">
            ...
            <ScrollReveal delay={0.2}>
              ...
              >
                ...
                <p className="mb-6 text-sm leading-relaxed text-text-muted">
                  Market sizing, financial modeling, and case competitions.
                  I work with teams to research industries, analyze data,
                  and deliver clear recommendations to real clients.
                </p>
                <div className="mb-4 flex flex-wrap gap-1.5">
                  {strategyItems.map((s) => (
            ...
            {projects.slice(0, 3).map((project, i) => (
              <ScrollReveal key={project.slug} delay={i * 0.1}>
                <Link
                  ...
                  data-hover
                  className="gradient-border gradient-border-hover card group relative block p-5 md:p-7"
                >
      ...
      <section className="section-spacing pt-0">
        <div className="container-shell">
          ...
          <div className="grid gap-8 md:grid-cols-[1.2fr_0.8fr] md:items-center">
            <ScrollReveal>
              <p className="font-display text-2xl font-bold leading-snug tracking-tight text-text sm:text-3xl md:text-4xl">
                CS and Economics.{" "}
            ...
            <ScrollReveal delay={0.15}>
              <div>
                <p className="text-sm leading-relaxed text-text-muted sm:text-base">
                  I study both because they let me do more. CS gives me the
                  skills to build real software. Economics gives me the thinking
                  to understand markets, industries, and what problems are
                  actually worth solving.
                </p>
                <Link
                  href="/about"
                  data-hover
                  className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-text-muted transition-all hover:gap-3 hover:text-text"
                >
                  Read more about me
