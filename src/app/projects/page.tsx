                  ...
                  <div className="relative py-10 md:py-14">
                    ...
                    <div className="relative">
                      ...
                      <div className="flex items-start justify-between gap-6">
                        ...
                        {/* Arrow */}
                        <div className="mt-3 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-border transition-all duration-300 group-hover:border-accent/30 group-hover:bg-accent/[0.06] md:h-12 md:w-12">
                          <svg
                            width="18"
                            height="18"
                            viewBox="0 0 18 18"
                            fill="none"
                            className="text-text-dim transition-all duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-accent"
                          >
                            <path
